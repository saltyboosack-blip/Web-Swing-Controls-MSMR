...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved) {
	...
	case DLL_PROCESS_ATTACH:
		...
		// Other executables in the game directory also import winmm.dll. Keep
		// forwarding intact for them, but never scan or hook their images.
		if (!scripts_proxy::IsMsmrHostProcess()) {
			break;
		}
